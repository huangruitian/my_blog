    ...
    sidebar: {
      "/pages/frontEnd/": [
        ...
        },
        {
          title: "react",
          // collapsable: false, // 可选的, 默认值是 true,
          children: ["react.md", "reactOptimization.md"],
        },
        {
          title: "redux",
          // collapsable: false, // 可选的, 默认值是 true,
        ...
        },
        {
          title: "浏览器",
          // collapsable: false, // 可选的, 默认值是 true,
          children: ["browser.md", "PerformanceOptimization.md"],
        },
        {
          title: "http",
          // collapsable: false, // 可选的, 默认值是 true,
        ...
        },
        {
          title: "websocket",
          // collapsable: false, // 可选的, 默认值是 true,
          children: ["websocket.md"],
        },
        {
          title: "TypeScript",
          // collapsable: false, // 可选的, 默认值是 true,
          children: ["typescript.md"],
        },
        {
          title: "webpack",
          // collapsable: false, // 可选的, 默认值是 true,
          children: ["webpack.md", "webpack2.md"],
        },
        {
          title: "node",
          // collapsable: false, // 可选的, 默认值是 true,
