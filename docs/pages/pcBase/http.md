...
![alt](./images/bao.png)
- 长度：在这个帧里，开头的三个字节是“00010a”，表示数据长度是 266 字节。
...
使用一些成熟的开源库即可，像 ModSecurity，它可以说是 WAF 界“事实上的标准”。
